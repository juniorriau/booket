...
class Myacl {
    ...
    protected $restrictFunction = array("__construct", "_rules", "_verify", "_loadConfig", "_auth", "_tppauth", "_removeRestrictFunction", "_hasAccess", "_generateMenus", "_generateButtons", "_getFunction", "get_instance", "_getModulesName");
    protected $CI;
    ...
    public function _btnRead($uri, $text = "") {
        return ('<a href="' . $uri . '" class="btn btn-sm btn-success"><i class="fas fa-eye"></i> ' . $text . '</a>');
    }
    ...
    public function _btnUpdate($uri, $text = "") {
        return ('<a href="' . $uri . '" class="btn btn-sm btn-info"><i class="fas fa-pen"></i> ' . $text . '</a>');
    }

    public function _btnDelete($uri, $text = "") {
        return ('<a href="' . $uri . '" class="btn btn-sm btn-warning" onclick="javasciprt: return confirm(\'Anda Yakin Ingin Hapus Data ?\')"><i class="fas fa-trash"></i> ' . $text . '</a>');
    }

    public function _btnDefault($uri, $text = "", $class = 'btn-default', $icons = "fa-square") {
        return ('<a href="' . $uri . '" class="btn btn-sm ' . $class . '"><i class="fas ' . $icons . '"></i> ' . $text . '</a>');
    }
