...
class Settings extends MY_Controller {
    ...
    public function update_action() {
        ...
        if (!empty($_FILES['filelogovertical']['name'])) {
            $result = fileuploader($_FILES, "filelogovertical");
            $this->Settings_model->update("site_logo_vertical", array('setting_value' => $result['message']['fullpath']));
        }
        if (!empty($_FILES['filelogohorizontal']['name'])) {
            $result = fileuploader($_FILES, "filelogohorizontal");
            $this->Settings_model->update("site_logo_horizontal", array('setting_value' => $result['message']['fullpath']));
        }
