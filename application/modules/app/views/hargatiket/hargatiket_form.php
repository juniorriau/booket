        ...
        <div class="panel panel-default">
            ...
            <div class="panel-body">
                <div class="form-group">
                    <label for="int">Rute
                        <?php echo form_error('rute') ?>
                    </label>
                    <select name="rute" id="rute" class="form-control">
                        <?php
                        if (!empty($rutelist)) {
                            foreach ($rutelist as $r) {
                                echo '<option value="' . $r->id . '" ' . ($r->id == $rute ? 'selected' : '') . '>' . $r->kotaasal." -> ".$r->kotatujuan . '</option>';
                ...
                <div class="row">
                    <div class="col-md-12">
                        <div>
                            ...
                            <a href="<?php echo site_url('app/hargatiket') ?>" class="btn btn-danger">Batal</a>
                        </div>
                    </div>
                </div>
            </div>
