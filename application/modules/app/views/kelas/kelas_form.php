...
<div id="content" class="padding-20">
    <form method="post" action="<?php echo $action ?>" autocomplete="off">
	    ...
	    <div class="form-group">
            <label for="varchar">Namakelas <?php echo form_error('namakelas') ?></label>
            <input type="text" class="form-control" name="namakelas" id="namakelas" placeholder="Namakelas" value="<?php echo $namakelas; ?>" />
        </div>
	    </div>
                ...
                <div class="row">
                    <div class="col-md-12">
                        <div>
                            ...
                            <a href="<?php echo site_url('app/kelas') ?>" class="btn btn-danger">Batal</a>
                        </div>
                    </div>
                </div>
            </div>
