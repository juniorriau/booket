            ...
            <div class="row">
                <div class="col-lg-4 col-md-4 col-md-12">
                    ...
                    if (in_array('create', $rolelist)) {
                        echo $this->myacl->_btnCreate(site_url('app/kelas/create'), "Tambah");
                    }
                    ?>
                </div>
                ...
                <div class="col-lg-4 col-md-4 col-sm-12 text-right">
                    <form action="<?php echo site_url('app/kelas/index'); ?>" class="form-inline" method="get">
                        <div class="input-group">
                            ...
                            <span class="input-group-btn">
                                ...
                                if ($q <> '') {
                                    ?>
                                    <a href="<?php echo site_url('app/kelas'); ?>" class="btn btn-sm btn-warning">Atur
                                        Ulang</a>
                                    <?php
                                }
                                ?>
                                ...
                                <div class="btn-group">
                                    ...
                                    <ul class="dropdown-menu" role="menu">
                                        ...
                                        if (in_array('update', $rolelist)) {
                                            echo "<li>" . $this->myacl->_btnUpdate(site_url('app/kelas/update/' . $kelas->id)) . "</li>";
                                        }

                                        if (in_array('delete', $rolelist)) {
                                            echo "<li>" . $this->myacl->_btnDelete(site_url('app/kelas/delete/' . $kelas->id)) . "</li>";
                                        }
                                        ?>
                                    </ul>
                                </div>
