    ...
    <div class="panel panel-default">
            ...
            <div class="row">
                <div class="col-lg-4 col-md-4 col-md-12">
                    ...
                    if (in_array('create', $rolelist)) {
                        echo $this->myacl->_btnCreate(site_url('app/perusahaan/create'), "Tambah");
                    }
                    ?>
                </div>
                ...
                <div class="col-lg-4 col-md-4 col-sm-12 text-right">
                    <form action="<?php echo site_url('app/perusahaan/index'); ?>" class="form-inline" method="get">
                        <div class="input-group">
                            ...
                            <span class="input-group-btn">
                                ...
                                if ($q <> '') {
                                    ?>
                                    <a href="<?php echo site_url('app/perusahaan'); ?>" class="btn btn-sm btn-warning">Atur Ulang</a>
                                    <?php
                                }
                                ?>
		...
		<th>Action</th>
			...
			<td style="text-align:center" width="250px">
                                <div class="btn-group">
                                    <button type="button" class="btn btn-teal dropdown-toggle" data-toggle="dropdown">Pilih Aksi <span class="caret"></span></button>
                                    <ul class="dropdown-menu" role="menu">
                                        <?php
                                        if (in_array('update', $rolelist)) {
                                            echo "<li>" . $this->myacl->_btnUpdate(site_url('app/perusahaan/update/' . $perusahaan->id)) . "</li>";
                                        }

                                        if (in_array('delete', $rolelist)) {
                                            echo "<li>" . $this->myacl->_btnDelete(site_url('app/perusahaan/delete/' . $perusahaan->id)) . "</li>";
                                        }
                                        ?>
                                    </ul>
                                </div>
