        ...
        <div class="panel-heading">
            <div class="row">
                <div class="col-lg-3 col-md-6 col-sm-12">
                    <?php echo anchor(site_url('auth/routings/create'), 'Create', 'class="btn btn-sm btn-primary"'); ?>
                    <?php echo anchor(site_url('auth/routings/generateAll'), 'Generate All Functions', 'class="btn btn-sm btn-success"'); ?>
                </div>
                    ...
                    <form action="<?php echo site_url('auth/routings/index'); ?>" class="form-inline" method="get">
                        <div class="input-group">
                            ...
                            <span class="input-group-btn">
                                ...
                                if ($q <> '') {
                                    ?>
                                    <a href="<?php echo site_url('auth/routings'); ?>" class="btn btn-sm btn-warning">Reset</a>
                                    <?php
                                }
                                ?>
