...
<html>
    ...
    <body>
		...
		<th>Action</th>
			...
			<td><?php echo $users->resetkey ?></td>
			<td><?php echo $users->resettime ?></td>
			<td><?php echo $users->currentlogin ?></td>
			<td><?php echo $users->lastlogin ?></td>
			<td><?php echo $users->createdat ?></td>
			<td><?php echo $users->createdby ?></td>
			<td><?php echo $users->updatedat ?></td>
			<td><?php echo $users->updatedby ?></td>
